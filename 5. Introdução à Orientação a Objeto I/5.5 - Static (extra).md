...
class Animal {
  ...
  constructor(type, name, age, hungry) {
    ...
    this.energy = 0;
    this.hungry = hungry;
    this.constructor.animals.push({ name: this.name, hungry: this.hungry }); //para acessar o método estático, precisa colocar o this.constructor.animals
  }
...
console.log(Animal.animals); //[] //puxa a classe e depois o método static
...
class Animal {
  ...
  static updateAnimalsHungry(name, updatedHungry) {
		...
		this.animals[animalIndex].hungry = updatedHungry; //aqui, não precisa ser feito o this.constructor.animals pq animals é uma propriedade estática.
    // métodos estáticos e propriedades estáticas se conhecem, então não precisa do constructor
	}
